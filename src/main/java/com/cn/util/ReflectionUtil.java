...
public class ReflectionUtil {
    ...
    public static Field[] getDeclaredFields(final Object object){
         ...
         for (Class < ? > superClass = object.getClass(); superClass != Object.class; superClass = superClass
                 .getSuperclass()) {
        	 self = (Field[]) ArrayUtils.addAll(self, superClass.getDeclaredFields());
         }
         return self;
    }
    /**
    ...
    public static Object getObjectValue(String paramNames , Object base) throws Exception{
    	String[] param = StringUtils.split(paramNames, ".");
    	Object object = null;
        for (int i = 1; i < param.length; i++) {
            if (i == 1) {
                object = ReflectionUtil.invokeGetterMethod(base, param[i]);
            }
            else {
                object = ReflectionUtil.invokeGetterMethod(object, param[i]);
            }
        }
        return object;
    }
